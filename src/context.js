...
const ContextProvider = ({children}) => {
    ...
    const getUpdate = async () => {
        try {
            const res = await axios.post(`${API}GetUpdate/`, {
    ...
    return (
        <Context.Provider value={{
            isDrawerOpen, setIsDrawerOpen, categories,
            setCategories, cards, setCards, categoryById,
            testimonials, setTestimonials, name, setName,
            component, setComponent, namePosition, setNamePosition,
            minDataPosition, setMinDataPosition, text, setText,
            image, setImage, getUpdate, emailUpdate, setEmailUpdate,
            firstName, setFirstName, lastName, setLastName, insta_ac, setInsta_ac,
